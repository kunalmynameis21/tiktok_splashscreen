...
database=await openDatabase(addDbName,version: 1,onCreate: (db,version){
db.execute("CREATE TABLE student(id INTEGER PRIMARY KEY AUTOINCREMENT,name TEXT,email TEXT)");
return db;
